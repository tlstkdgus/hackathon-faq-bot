...
|---|---|
| 이름 | `faq-bot` (아무거나) |
| 이미지 | **Canonical Ubuntu 22.04** 이상 |
| Shape | 아래 참고 |
| 네트워킹 | 기본값 그대로 (공용 IP 할당 켜기) |
...
- 최대 4 OCPU, 24GB RAM — 훨씬 좋습니다
- 하지만 **"Out of capacity" 오류로 생성이 계속 실패합니다.** 특히 서울/춘천은
  거의 항상 만석입니다. 몇 시간~며칠씩 재시도해야 잡히는 경우가 흔합니다

봇 하나 돌리는 데 24GB RAM은 아무 의미가 없습니다. **AMD Micro로 시작하세요.**
...
Always Free 인스턴스는 **7일 넘게 완전히 유휴 상태**면 회수될 수 있습니다.
봇이 계속 떠 있으면 해당 없습니다. 걱정되면 오라클 콘솔에서 유료 계정으로
업그레이드(실제 과금은 Always Free 범위 초과 시에만)하면 회수 대상에서 빠집니다.
